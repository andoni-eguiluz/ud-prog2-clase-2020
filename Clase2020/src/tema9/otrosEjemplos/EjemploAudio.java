...
public class EjemploAudio {
	...
	private static int QUE_PRUEBA = 1;  // 1 - audio sin hilo   2 - audio con hilo
	...
	private static void pruebaSinHilos() {
		lanzaAudio( "src/tema9/otrosEjemplos/timbre.wav" );
		lanzaAudio( "src/tema9/otrosEjemplos/aplauso.wav" );
		System.out.println( "Sólo se ve después de los dos audios");
	}

	private static void pruebaConHilos() {
		lanzaAudioEnHilo( "src/tema9/otrosEjemplos/timbre.wav" );
		try { Thread.sleep(2000); } catch (Exception e) {}
		lanzaAudioEnHilo( "src/tema9/otrosEjemplos/aplauso.wav" );
