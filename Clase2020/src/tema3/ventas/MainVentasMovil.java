...
public class MainVentasMovil {
	...
	private static final Producto[] PRODS = {
		new Movil( "Lo nuevo de Samsung", 1359.00, "/tema3/ventas/s20.png", "Samsung", "Galaxy S20" ),
		new Servicio( "Instalación apps" ),
		new Movil( "Móvil sin Coltán", 450.00, "/tema3/ventas/fairphone3.png", "Fairphone", "3" ),
		new Movil( "El 11 de Apple", 1329.00, "/tema3/ventas/iphone11.png", "Apple", "IPhone 11 Pro" ),
